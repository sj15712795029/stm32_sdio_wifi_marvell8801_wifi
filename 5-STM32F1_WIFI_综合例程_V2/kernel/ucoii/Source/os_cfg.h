...
#define OS_LOWEST_PRIO           CONF_RTOS_MAX_PRIO   /* Defines the lowest priority that can be assigned ...         */
...
#define OS_TICKS_PER_SEC       	CONF_RTOS_TICKS_PER_SEC   /* Set the number of ticks in one second                        */
...
#define OS_TASK_IDLE_STK_SIZE   CONF_IDLE_TASK_STACK_SIZE   /* Idle       task stack size (# of OS_STK wide entries)        */
