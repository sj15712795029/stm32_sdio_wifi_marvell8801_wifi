...
extern uint32_t rtos_ticks;
extern void sys_check_timeouts(void);
uint32_t sys_now(void)
{
    return rtos_ticks*(1000/CONF_RTOS_TICKS_PER_SEC);
}
...
int main()
{
    ...
    hw_led_init();
    hw_oled_init();
    hw_systick_init(SystemCoreClock/CONF_RTOS_TICKS_PER_SEC);

    HW_DEBUG("Marvell88w8801 rtthread wifi testing......\n");
    rtos_init();
