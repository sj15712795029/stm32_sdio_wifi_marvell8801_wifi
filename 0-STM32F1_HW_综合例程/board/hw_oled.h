...
#define SSD1306_PERIPH_CLK RCC_APB2Periph_GPIOB
...
#define IIC_SCLK_LOW GPIO_ResetBits(SSD1306_SCL_GPIO,SSD1306_SCL_PIN)
#define IIC_SCLK_HIGH GPIO_SetBits(SSD1306_SCL_GPIO,SSD1306_SCL_PIN)
#define IIC_SDIN_LOW GPIO_ResetBits(SSD1306_SDA_GPIO,SSD1306_SDA_PIN)
#define IIC_SDIN_HIGH GPIO_SetBits(SSD1306_SDA_GPIO,SSD1306_SDA_PIN)
