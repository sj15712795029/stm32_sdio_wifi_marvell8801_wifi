...
//	<i>Default: 32
#define RT_THREAD_PRIORITY_MAX  CONF_RTOS_MAX_PRIO
// <o>OS tick per second
//  <i>Default: 1000   (1ms)
#define RT_TICK_PER_SECOND	CONF_RTOS_TICKS_PER_SEC
...
//  <i>Default: 100
#define RT_TIMER_TICK_PER_SECOND	CONF_RTOS_TICKS_PER_SEC
// </e>
