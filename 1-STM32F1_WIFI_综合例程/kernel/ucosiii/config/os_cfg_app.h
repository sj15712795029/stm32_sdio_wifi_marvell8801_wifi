...
#define  OS_CFG_ISR_STK_SIZE             CONF_ISR_STACK_SIZE               /* Stack size of ISR stack (number of CPU_STK elements)   */
#define  OS_CFG_TASK_STK_LIMIT_PCT_EMPTY  10u               /* Stack limit position in percentage to empty            */


                                                            /* ---------------------- IDLE TASK --------------------- */
#define  OS_CFG_IDLE_TASK_STK_SIZE       CONF_IDLE_TASK_STACK_SIZE               /* Stack size (number of CPU_STK elements)                */
...
#define  OS_CFG_STAT_TASK_STK_SIZE       128u               /* Stack size (number of CPU_STK elements)                */
                                                            ...
                                                            /* ------------------------ TICKS ----------------------- */
#define  OS_CFG_TICK_RATE_HZ            CONF_RTOS_TICKS_PER_SEC               /* Tick rate in Hertz (10 to 1000 Hz)                     */
